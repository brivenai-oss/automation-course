            ...
            <div style={{ background: "#fff", border: `1px solid ${T.parchmentDim}`, borderRadius: 10, padding: "20px 22px", marginBottom: 26, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
                <div>
                  ...
                  <p style={{ fontFamily: FONTS.body, fontSize: 13.5, color: T.inkSoft, margin: 0, maxWidth: 380 }}>
                    A rough n8n-shaped skeleton built from this plan — <strong>a draft starting point, not a
                    finished workflow.</strong> Every node needs real credentials and field mappings before it'll run.
                  </p>
                </div>
                <button
                  className="no-print"
                  onClick={() => downloadJSON(buildN8nSkeleton(result), "n8n-workflow-draft.json")}
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: 7,
